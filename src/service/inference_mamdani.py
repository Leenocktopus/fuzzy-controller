import itertools
import numpy as np
from src.service import membership_functions, fuzzifier, defuzzifier, fuzzy_operators
...
def process(input_lvs, output_lv, rule_base, crisp_values):
    ...
    crisp_result = defuzzifier.defuzzification(output_lv['U'], result_fuzzy_set)
    word_result = []
